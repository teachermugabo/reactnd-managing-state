...
**Task**: Create a game that shows an equation of the form X+Y+Z=P. 
Here, X, Y, and Z should be random numbers, and P should be the proposed answer. The
...
The render method gets called automatically every time the state changes
